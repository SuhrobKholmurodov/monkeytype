    ...
    <header className="fixed top-0 left-0 w-full bg-gray-900 text-white py-4 px-6 flex justify-between items-center shadow-md z-50">
      <div className="flex flex-col items-start">
        <Link to={'/'} className="text-lg font-bold">
          Monkey Type
          <HeaderTooltip title="Move to the official website">
            <div className="flex gap-1 items-center">
              <p className="font-bold text-[14px]">Inspired by:</p>
              <a target="_blank" href="https://monkeytype.com/">
                <svg
                  height={'16px'}
                  style={{ fill: '#e2b714' }}
      ...
      <div className="flex gap-6 items-center">
        <HeaderTooltip title="View the source code on GitHub">
          <a
        ...
        <HeaderTooltip title="View your profile">
