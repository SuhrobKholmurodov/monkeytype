  ...
  return (
    <div className="flex justify-between gap-[20px]">
      <div
        ...
        className="flex justify-between text-center text-gray-200 gap-[100px] bg-gray-800 p-4 rounded-lg"
      >
      ...
      <div
        id="maxsScoreByWords"
        className="flex justify-between text-center text-white gap-[100px] bg-gray-800 p-4 rounded-lg"
      >
